const translations = {
  "en": {
    ...
    "ov_learn_2": "How wet-lab nanobody phage display screening of target antigen works",
    "ov_learn_3": "How computational and AI workflows are useful to store, model, rank, design and simulate nanobody candidates",
  ...
  "it": {
    ...
    "ov_learn_2": "Come funziona lo screening wet-lab di phage display per nanobody contro l'antigene bersaglio",
    "ov_learn_3": "Come i flussi di lavoro computazionali e di IA sono utili per archiviare, modellare, classificare, progettare e simulare candidati nanobody",
  ...
  "sl": {
    ...
    "ov_learn_2": "Kako deluje mokro-laboratorijski (wet-lab) presejalni test s fagnim prikazom (phage display) nanoteles proti ciljnemu antigenu",
    "ov_learn_3": "Kako so računalniški delovni tokovi in delovni tokovi umetne inteligence uporabni za shranjevanje, modeliranje, razvrščanje, načrtovanje in simulacijo kandidatov za nanoteelesa",
  ...
  "fr": {
    ...
    "ov_learn_2": "Comment fonctionne le criblage par phage display en laboratoire humide (wet-lab) pour les nanocorps ciblant un antigène",
    "ov_learn_3": "Comment les flux de travail informatiques et d'IA sont utiles pour stocker, modéliser, classer, concevoir et simuler des candidats nanocorps",
  ...
  "es": {
    ...
    "ov_learn_2": "Cómo funciona el cribado por phage display en laboratorio húmedo (wet-lab) de nanocuerpos frente a un antígeno diana",
    "ov_learn_3": "Cómo los flujos de trabajo computacionales y de IA son útiles para almacenar, modelar, clasificar, diseñar y simular candidatos a nanocuerpos",
  ...
  "de": {
    ...
    "ov_learn_2": "Wie das Nasslabor-Screening (Wet-Lab) von Nanobodies mittels Phage Display gegen ein Zielantigen funktioniert",
    "ov_learn_3": "Wie computergestützte und KI-Workflows beim Speichern, Modellieren, Einstufen, Entwerfen und Simulieren von Nanobody-Kandidaten nützlich sind",
