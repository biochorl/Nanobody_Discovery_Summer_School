const translations = {
  "en": {
    ...
    "ab_org_desc": "This Summer School is jointly organised by members of the Laboratory of Environmental and Life Sciences at the University of Nova Gorica. We are grateful for the support of everyone who helped to make this event possible.",
    "ab_scicomm": "",
  ...
  "it": {
    ...
    "ab_org_desc": "Questa Summer School è organizzata dai membri del Laboratory of Environmental and Life Sciences della University of Nova Gorica. Siamo grati per il supporto di tutti coloro che hanno contribuito a rendere possibile questo evento.",
    "ab_scicomm": "",
  ...
  "sl": {
    ...
    "ab_org_desc": "To poletno šolo organizirajo člani Laboratorija za vede o okolju in življenju na Univerzi v Novi Gorici. Hvaležni smo za podporo vsem, ki so pomagali omogočiti ta dogodek.",
    "ab_scicomm": "",
  ...
  "fr": {
    ...
    "ab_org_desc": "Cette École d'été est co-organisée par les membres du Laboratoire des sciences de l'environnement et de la vie de l'Université de Nova Gorica. Nous sommes reconnaissants du soutien de tous ceux qui ont contribué à rendre cet événement possible.",
    "ab_scicomm": "",
  ...
  "es": {
    ...
    "ab_org_desc": "Esta Escuela de Verano está organizada conjuntamente por miembros del Laboratorio de Ciencias Ambientales y de la Vida de la Universidad de Nova Gorica. Agradecemos el apoyo de todos los que ayudaron a hacer posible este evento.",
    "ab_scicomm": "",
  ...
  "de": {
    ...
    "ab_org_desc": "Diese Sommerschule wird gemeinsam von Mitgliedern des Labors für Umwelt- und Lebenswissenschaften der Universität Nova Gorica organisiert. Wir sind dankbar für die Unterstützung aller, die dazu beigetragen haben, diese Veranstaltung zu ermöglichen.",
    "ab_scicomm": "",
